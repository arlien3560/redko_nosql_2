...
Зв’язок виводиться так. Квадрат L2-відстані: ∥a−b∥2=∥a∥2+∥b∥2−2(a⋅b)\|a-b\|^2 = \|a\|^2 + \|b\|^2 - 2(a \cdot b)
∥a−b∥2=∥a∥2+∥b∥2−2(a⋅b). Для нормалізованих векторів ∥a∥2=∥b∥2=1\|a\|^2 = \|b\|^2 = 1
∥a∥2=∥b∥2=1, тому ∥a−b∥2=2−2(a⋅b)\|a-b\|^2 = 2 - 2(a \cdot b)
∥a−b∥2=2−2(a⋅b). А для одиничних векторів a⋅b=cos⁡(θ)a \cdot b = \cos(\theta)
a⋅b=cos(θ), отже ∥a−b∥2=2−2cos⁡(θ)\|a-b\|^2 = 2 - 2\cos(\theta)
∥a−b∥2=2−2cos(θ).
