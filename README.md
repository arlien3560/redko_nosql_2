...
От приклад з завдання 4 - для документа з cosine = 0.8294 формула дає √(2 − 2 × 0.8294) = √0.3412 ≈ 0.5841, а прямий розрахунок L2 дав 0.5842. По суті різниця тільки в точності останнього знака. Але результат видачі був однаковий.
